<template>
  <div>
    <div
      :class="[{ 'col-md-4': vertical && !tabNavWrapperClasses }, { 'col-12': centered && !tabNavWrapperClasses }, tabNavWrapperClasses]"
    >
      <b-nav
        class="nav-pills"
        role="tablist"
        :class="[`nav-pills-${type}`, { 'flex-column': vertical }, { 'justify-content-center': centered }, tabNavClasses]"
      >
        <b-nav-item
          v-for="tab in tabs"
          class="active"
