...
export default class ChartValues extends Vue {
  ...
  public retrieveAllChartValuess(): void {
  ...
  public prepareRemove(instance: IChartValues): void {
  ...
  public removeChartValues(): void {
    this.chartValuesService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A ChartValues is deleted with identifier ' + this.removeId;
