<template>
  <div>
    <h2 id="page-heading" data-cy="ActionHeading">
      <span id="action-heading">Actions</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="smartclinicApp.action.delete.question" data-cy="actionDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-action-heading">Are you sure you want to delete this Action?</p>
      </div>
