...
export default class DetailsOfVisit extends Vue {
  ...
  public prepareRemove(instance: IDetailsOfVisit): void {
  ...
  public removeDetailsOfVisit(): void {
    this.detailsOfVisitService()
      .delete(this.removeId)
      .then(() => {
        const message = 'A DetailsOfVisit is deleted with identifier ' + this.removeId;
