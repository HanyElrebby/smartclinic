      ...
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          <div class="form-group row" v-if="file.id">
            <label class="col-md-2 col-form-label form-control-label" for="id">ID</label>
            <div class="col-md-10">
              <base-input type="text" alternative id="id" name="id" v-model="file.id" readonly />
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-2 col-form-label form-control-label" for="file-patient">Patient</label>
            <div class="col-md-10">
          ...
          <div class="form-group row">
            <label class="col-md-2 col-form-label form-control-label" for="file-file">File</label>
            <div class="col-md-10">
          ...
          <div class="form-group row">
            <label class="col-md-2 col-form-label form-control-label" for="file-fileName">File Name</label>
            <div class="col-md-10">
              <base-input
                type="text"
                name="file Name"
          ...
          <div class="form-group row">
            <label class="col-md-2 col-form-label form-control-label" for="file-note">Note</label>
            <div class="col-md-10">
