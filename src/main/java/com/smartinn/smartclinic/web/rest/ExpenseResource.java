...
import com.smartinn.smartclinic.service.ExpenseService;
...
/**
 * REST controller for managing {@link com.smartinn.smartclinic.domain.Expense}.
 */
@RestController
@RequestMapping("/api")
public class ExpenseResource {
    ...
    public ExpenseResource(ExpenseService expenseService, SafeService safeService, ExpenseRepository expenseRepository) {
    ...
    public ResponseEntity<Expense> createExpense(@Valid @RequestBody Expense expense) throws URISyntaxException {
        ...
        Optional<Safe> safe = safeService.getSafeBySecretary(username);
        expense.setSafe(safe.get());
