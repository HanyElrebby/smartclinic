...
class PatientResourceIT {
    ...
    private static final String DEFAULT_FIRST_FATHER_NAME = "AAAAAAAAAA";
    private static final String UPDATED_FIRST_FATHER_NAME = "BBBBBBBBBB";
    ...
    private static final String DEFAULT_PLACE_OF_RESIDENCE = "AAAAAAAAAA";
    private static final String UPDATED_PLACE_OF_RESIDENCE = "BBBBBBBBBB";
    ...
    public static Patient createEntity(EntityManager em) {
        Patient patient = new Patient()
            ...
            .pesel(DEFAULT_PESEL)
            .firstFatherName(DEFAULT_FIRST_FATHER_NAME)
    ...
    public static Patient createUpdatedEntity(EntityManager em) {
        Patient patient = new Patient()
            ...
            .pesel(UPDATED_PESEL)
            .firstFatherName(UPDATED_FIRST_FATHER_NAME)
    ...
    void createPatient() throws Exception {
        ...
        assertThat(testPatient.getPesel()).isEqualTo(DEFAULT_PESEL);
        assertThat(testPatient.getFirstFatherName()).isEqualTo(DEFAULT_FIRST_FATHER_NAME);
        assertThat(testPatient.getContactNumber()).isEqualTo(DEFAULT_CONTACT_NUMBER);
    ...
    @Test
    @Transactional
    void checkPeselIsRequired() throws Exception {
        int databaseSizeBeforeTest = patientRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    void checkFirstFatherNameIsRequired() throws Exception {
        int databaseSizeBeforeTest = patientRepository.findAll().size();
        // set the field null
        patient.setFirstFatherName(null);
    ...
    @Test
    @Transactional
    void checkPlaceOfResidenceIsRequired() throws Exception {
        int databaseSizeBeforeTest = patientRepository.findAll().size();
        // set the field null
        patient.setPlaceOfResidence(null);
    ...
    @Test
    @Transactional
    void checkBloodGroupIsRequired() throws Exception {
        int databaseSizeBeforeTest = patientRepository.findAll().size();
        // set the field null
    ...
    void getAllPatients() throws Exception {
        ...
        restPatientMockMvc
            ...
            .andExpect(jsonPath("$.[*].firstFatherName").value(hasItem(DEFAULT_FIRST_FATHER_NAME)))
    ...
    void getPatient() throws Exception {
        ...
        restPatientMockMvc
            ...
            .andExpect(jsonPath("$.firstFatherName").value(DEFAULT_FIRST_FATHER_NAME))
    ...
    void putNewPatient() throws Exception {
        ...
        assertThat(testPatient.getPesel()).isEqualTo(UPDATED_PESEL);
        assertThat(testPatient.getFirstFatherName()).isEqualTo(UPDATED_FIRST_FATHER_NAME);
        assertThat(testPatient.getContactNumber()).isEqualTo(UPDATED_CONTACT_NUMBER);
