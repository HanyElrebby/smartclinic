...
import FileUpdateComponent from '@/entities/file/file-update.vue';
import FileClass from '@/entities/file/file-update.component';
...
describe('Component Tests', () => {
  describe('File Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<FileClass>(FileUpdateComponent, {
        store,
        localVue,
        router,
        provide: {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        const entity = { id: 123 };
        comp.file = entity;
        fileServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(fileServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.file = entity;
        fileServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(fileServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
    ...
    describe('Before route enter', () => {
      it('Should retrieve data', async () => {
        ...
        fileServiceStub.retrieve.resolves([foundFile]);
